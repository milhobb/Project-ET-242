...
- правда тут как раз вопрос, если мы сделаем бд только с временными рядами, то возможно это по-другому будет реализовано (но тогда кнопка просто загрузки фото без сиюминутной переделки в контур, а потом во временной ряд не нужна)
